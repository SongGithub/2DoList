...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Item.category'
        db.alter_column(u'to_do_list_app_item', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=' ', to=orm['to_do_list_app.Category']))
    ...
    models = {
        ...
        u'to_do_list_app.item': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['to_do_list_app.Category']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'blank': 'True'})
        }
    }
